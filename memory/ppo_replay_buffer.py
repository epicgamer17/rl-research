...
class ReplayBuffer:
    def __init__(self, observation_dimensions, max_size: int, gamma = 0.99, gae_lambda = 0.95):
    ...
    def finish_trajectory(self, last_value=0):
        ...
        self.advantage_buffer[path_slice] = discounted_cumulative_sums(deltas, self.gamma * self.gae_lambda)
    ...
    def get(self):
        ...
        self.advantage_buffer = (self.advantage_buffer - advantage_mean) / (advantage_std  + 1e-10) # avoid division by zero
        return dict(
