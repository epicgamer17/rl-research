...
class TestStatsViz(unittest.TestCase):
    ...
    def test_chance_probs_plotting(self):
        ...
        tracker.add_plot_types("chance_probs", PlotType.BAR, bar_threshold=0.01, show_all_bars=True)
    ...
    def test_latent_pca_saving(self):
        ...
        self.assertTrue(os.path.exists(expected_file), "Latent PCA visualization file was not saved.")
    ...
    def test_latent_bfloat16_pca_saving(self):
        ...
        expected_file = os.path.join(self.test_dir, "test_model_bf16_latent_viz_bf16_pca.png")
        self.assertTrue(os.path.exists(expected_file), "BFloat16 Latent PCA visualization file was not saved.")
