...
def test_assertions():
    ...
    try:
        ...
        print(
            "FAILED: categorical_crossentropy should have raised AssertionError with float32"
        )
    ...
    try:
        ...
        print(
            f"FAILED: categorical_crossentropy raised AssertionError with float16: {e}"
        )
    ...
    try:
        ...
        print(
            f"FAILED: categorical_crossentropy raised AssertionError with bfloat16: {e}"
        )
